...
const sourceCards = [
  {
    ...
    description:
      "We track open-source repo movement and rising engineering interest from the GitHub ecosystem.",
    logo: "https://www.devtrends.pro/_next/image?url=%2Fimages%2Fgithub-custom.png&w=3840&q=75",
  },
  {
    title: "Stack Overflow",
    description:
      "Hot questions reveal what developers are actively struggling with, learning, and shipping.",
    logo: "https://stackoverflow.com/Content/Sites/stackoverflow/Img/logo.png?v=0a124c963f5f",
  },
  {
    title: "Reddit communities",
    description:
      "Programming, webdev, and javascript discussions add real-world community momentum to the signal.",
    logo: "https://redditinc.com/hubfs/Reddit%20Inc/Content/Brand%20Page/Reddit_Lockup_Logo.svg",
  },
  {
    title: "Hacker News",
    description:
      "We use Hacker News to capture broader product, startup, and engineering conversations.",
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-[linear-gradient(180deg,#f8fbff_0%,#eef6ff_35%,#fff9f1_100%)] text-slate-900">
      <div className="relative">
        ...
        <header className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-10">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-lg uppercase tracking-[0.15em] text-sky-700">
                TechBit
              </p>
          ...
          <div className="max-w-3xl">
            <div className="mb-6 flex flex-wrap items-center gap-2">
              {[
                ...
                <span
                  key={label}
                  className="inline-flex items-center gap-2 rounded-full border border-sky-200 bg-white/75 px-4 py-2 text-sm font-medium text-sky-800 backdrop-blur"
                >
                  {label}
                </span>
              ))}
            ...
            <h1 className="max-w-4xl font-serif text-5xl leading-[0.95] tracking-tight text-slate-950 sm:text-6xl lg:text-7xl">
              One place to understand what developers are talking about and why
              it matters.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-slate-600 sm:text-xl">
              TechBit is a developer-first discovery platform that turns
              fragmented ecosystem chatter into trends, semantic search results,
              personalized feeds, learning context, and smarter technical posts.
            </p>
            ...
            <div className="mt-12 grid gap-4 sm:grid-cols-3">
              {[
                [
                  "4 trend sources",
                  "GitHub, Stack Overflow, Reddit, and Hacker News",
                ],
                [
                  "Semantic ranking",
                  "Embeddings connect interests to the right posts",
                ],
                [
                  "AI-assisted content",
                  "TLDR generation and technical context enrichment",
                ],
              ].map(([label, copy]) => (
                <div
                  key={label}
                  className="rounded-2xl border border-white/80 bg-white/70 p-4 shadow-[0_10px_30px_rgba(15,23,42,0.06)] backdrop-blur"
                >
              ...
              <div className="rounded-[1.5rem] border border-white/10 bg-[linear-gradient(160deg,#0f172a_0%,#111827_46%,#1e293b_100%)] p-6">
                ...
                <div className="mt-6 space-y-4">
                  {[
                    [
                      "Trend engine",
                      "Multiple sources are aggregated, normalized, deduplicated, and ranked into a single trends layer.",
                    ],
                    [
                      "Personal feed",
                      "Posts are scored by semantic similarity, trend alignment, engagement, and freshness.",
                    ],
                    [
                      "AI layer",
                      "Semantic search, TLDR generation, and content enrichment help developers move faster through dense information.",
                    ],
                ...
                <div className="mt-6 grid grid-cols-2 gap-3 text-sm">
                  <div className="rounded-2xl border border-orange-400/20 bg-orange-400/10 p-4">
                    ...
                    <p className="mt-2 text-slate-200">
                      It connects trends, learning, search, and posting instead
                      of treating them as separate features.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-sky-400/20 bg-sky-400/10 p-4">
                    <p className="text-sky-200">What developers get</p>
                    <p className="mt-2 text-slate-200">
                      A feed and search experience shaped by technical
                      relevance, not just vanity engagement.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <section id="sources" className="mx-auto max-w-7xl px-6 py-18 lg:px-10">
        <div className="mb-10 max-w-3xl">
          ...
          <h2 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">
            We gather signals from places developers already trust.
          </h2>
          <p className="mt-4 text-lg leading-8 text-slate-600">
            TechBit watches major developer ecosystems and turns scattered
            movement into one coherent picture of what is rising, useful, or
            worth learning.
          </p>
        </div>
        ...
        <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
          {sourceCards.map((card) => (
            <div
              key={card.title}
              className="group rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_16px_40px_rgba(15,23,42,0.06)] transition-transform hover:-translate-y-1"
            >
              <img
                src={card.logo}
                alt={card.title}
      ...
      <section className="border-y border-slate-200 bg-white/70 py-18 backdrop-blur">
        <div className="mx-auto grid max-w-7xl gap-10 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">
              A ranking system made for developer relevance.
            </h2>
            <p className="mt-4 text-lg leading-8 text-slate-600">
              The feed is not just latest-first. It balances semantic
              similarity, trend momentum, engagement, and recency, then applies
              diversity so you do not get trapped in the same topic loop.
            </p>
          </div>
          ...
          <div className="space-y-4">
            {feedSteps.map((item) => (
              <div
                key={item.step}
                className="rounded-[1.75rem] border border-slate-200 bg-white p-6 shadow-[0_14px_34px_rgba(15,23,42,0.05)]"
              >
      ...
      <section className="mx-auto max-w-7xl px-6 py-18 lg:px-10">
        <div className="mb-10 max-w-3xl">
          <p className="font-mono text-xs uppercase tracking-[0.32em] text-slate-400">
            What makes TechBit useful
          </p>
          <h2 className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">
            The app explains itself through the product.
          </h2>
        </div>
        ...
        <div className="grid gap-5 lg:grid-cols-2">
          {featureCards.map(({ icon, title, copy }) => {
            ...
            return (
              <div
                key={title}
                className="rounded-[1.75rem] border border-slate-200 bg-[linear-gradient(180deg,#ffffff_0%,#f8fbff_100%)] p-6 shadow-[0_18px_42px_rgba(15,23,42,0.05)]"
              >
        ...
        <div className="mx-auto grid max-w-7xl gap-12 px-6 lg:grid-cols-[0.9fr_1.1fr] lg:px-10">
          <div>
            ...
            <h2 className="mt-3 text-4xl font-semibold tracking-tight">
              More signal, less random scrolling.
            </h2>
            <p className="mt-4 text-lg leading-8 text-slate-300">
              TechBit combines trend discovery, semantic retrieval, AI-assisted
              writing, and learning workflows into one developer product instead
              of scattering them across tools.
            </p>
            <p className="mt-4 text-lg leading-8 text-slate-300">
              Built by : <br />
              <a href="https://www.github.com/Yashraj634" className="text-sky-400 hover:text-sky-500">Yashraj Sargam</a>,
              <a href="https://github.com/manas-senpai" className="text-sky-400 hover:text-sky-500"> Atharavraj Dhumal</a>,
              <a href="https://github.com/parassadafule" className="text-sky-400 hover:text-sky-500"> Paras Sadafule</a>,
              <a href="https://github.com/Sahil-Shaikh1311" className="text-sky-400 hover:text-sky-500"> Sahil Shaikh</a>
              <a href="https://github.com/vaibhavmashal" className="text-sky-400 hover:text-sky-500"> Vaibhav Mashal</a>
            </p>
          </div>
